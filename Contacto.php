...
<nav class="navbar navbar-expand-lg custom-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">PediYa </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="menu.php"><i class="fas fa-bars"></i> Menú</a>
                </li>
                <?php endif; ?>
            </ul>
   ...
   <div class="container">
    <h1 class="text-center mt-4">Equipo de PediYa</h1>
    <div class="team-members">
        ...
        <div class="team-member">
            <img src="img/foto4.jpeg" alt="Foto de Lilian Alejandra Montoya Mazariego">
            <div class="team-member-info">
                <h4>Lilian Alejandra Montoya Mazariego</h4>
                <p>Correo electrónico: <a href="mailto:correo2@cafetinudb.com">Lilian@gmail.com</a></p>
                <p>Encargado de Operaciones 
                <!--  <br> +503 </p> -->
                <div class="social-links">
                    <a href="#" target="_blank"><i class="fab fa-facebook"></i></a>
                    <a href="https://github.com/CastroJC7" target="_blank"><i class="fab fa-github"></i></a>
